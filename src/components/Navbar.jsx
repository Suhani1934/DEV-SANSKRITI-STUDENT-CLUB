...
const Navbar = () => {
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg navbar-dark sticky-top shadow animated-navbar ${
          ...
          <ul className="navbar-nav ms-auto align-items-lg-center gap-lg-3 mt-3 mt-lg-0">
            ...
            <li className="nav-item">
              <Link to="/clubs" className="nav-link nav-animated-link">
                <i className="bi bi-trophy-fill me-1"></i>Clubs
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/activities" className="nav-link nav-animated-link">
            ...
            {isLoggedIn && (
              <>
                ...
                <li className="nav-item">
                  <button
                    className="btn btn-warning btn-sm ms-lg-3 mt-2 mt-lg-0 d-flex align-items-center gap-1"
